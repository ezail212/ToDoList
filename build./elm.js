							...
							return $elm$json$Json$Encode$object(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'isCompleted',
										$elm$json$Json$Encode$bool($.isCompleted)),
										_Utils_Tuple2(
										'isEditing',
										$elm$json$Json$Encode$bool($.isEditing))
									]));
						})($.entries)),
					_Utils_Tuple2(
					'field',
...
var $author$project$Main$NothingToDo = {$: 'NothingToDo'};
...
var $author$project$Main$newEntry = F2(
	function (content, id) {
		return {content: content, id: id, isCompleted: false, isEditing: false};
	});
		...
		switch (msg.$) {
			...
			case 'ClearCompleted':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'CheckAll':
				var isAllCompleted = msg.a;
				var changeStatus = function (entry) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							entries: A2($elm$core$List$map, changeStatus, model.entries)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Check':
				var id = msg.a;
			...
			case 'EditingEntry':
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						function (_v1) {
							return $author$project$Main$NothingToDo;
						},
						focus));
			default:
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/ezail212')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Ezail212')
						]))
				])),
			A2(
			$elm$html$Html$p,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('PPTang has ugly hair')
				]))
		]));
...
var $author$project$Main$clearCompletedEntries = function (entriesCompleted) {
	return A2(
...
var $author$project$Main$numberOfActiveEntries = function (entriesLeft) {
	var itemString = ((entriesLeft === 1) || (!entriesLeft)) ? 'todo item' : 'todo items';
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$text(' ' + (itemString + ' left'))
			]));
};
...
var $author$project$Main$visibilitySwap = F3(
	function (childPageLink, visibilityType, visibility) {
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(childPageLink),
							$elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'selected',
									_Utils_eq(visibilityType, visibility))
								]))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(visibilityType)
						]))
				]));
	});
...
var $author$project$Main$viewControls = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Lazy$lazy, $author$project$Main$numberOfActiveEntries, entriesLeft),
					A2($elm$html$Html$Lazy$lazy, $author$project$Main$clearCompletedEntries, entriesCompleted),
...
var $author$project$Main$viewSingleEntry = function (entry) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('completed', entry.isCompleted),
						_Utils_Tuple2('editing', entry.isEditing)
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(entry.isCompleted),
								$elm$html$Html$Events$onClick(
								A2($author$project$Main$Check, entry.id, !entry.isCompleted))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$label,
						_List_fromArray(
							[
								...
								A2($author$project$Main$EditingEntry, entry.id, true))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(entry.content),
						$elm$html$Html$Attributes$name('title'),
						$elm$html$Html$Attributes$id(
						'todo-' + $elm$core$String$fromInt(entry.id)),
						$elm$html$Html$Events$onInput(
						$author$project$Main$UpdateEntry(entry.id)),
						$elm$html$Html$Events$onBlur(
						A2($author$project$Main$EditingEntry, entry.id, false)),
...
var $author$project$Main$viewAllEntry = function (entry) {
	return _Utils_Tuple2(
		$elm$core$String$fromInt(entry.id),
		A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewSingleEntry, entry));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$checked(isAllCompleted),
							$elm$html$Html$Events$onClick(
							$author$project$Main$CheckAll(!isAllCompleted))
						]),
					_List_Nil),
					A2(
					$elm$html$Html$label,
					...
					A2(
						$elm$core$List$map,
						$author$project$Main$viewAllEntry,
...
var $author$project$Main$viewInput = function (field) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('Write your todo list here'),
						...
						$author$project$Main$onEnter($author$project$Main$AddEntry)
					]),
				_List_Nil)
			]));
};
											...
											A2(
												...
												$elm$json$Json$Decode$list(
													A2(
																	...
																	return A2(
																		...
																		function (id) {
																			return A2(
																				...
																				function (content) {
																					return $elm$json$Json$Decode$succeed(
																						{content: content, id: id, isCompleted: isCompleted, isEditing: isEditing});
																				},
														...
														A2($elm$json$Json$Decode$field, 'isEditing', $elm$json$Json$Decode$bool)))));
									},
